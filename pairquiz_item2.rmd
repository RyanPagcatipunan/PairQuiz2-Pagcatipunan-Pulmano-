...
**A scatter plot could be made using R**
    ...
    ![Relationship Between Noise Exposure and Hypertension](https://github.com/RyanPagcatipunan/PairQuiz2-Pagcatipunan-Pulmano-/blob/2f0491235a7f62da1e5647f9124b128a23a8faec/Relatipnship%20between%20Noise%20and%20Hypertension.png)
...
Y = β_0 +β_1*x
$$
**It can be solved using Rstudio**
...
Seeing that β_0 = -10.13154 and β_1 = 0.17429, the linear regression model would be
...
**Variance can also be solved using Rstudio**

var(x=soundpressure,y=bloodpressure)
